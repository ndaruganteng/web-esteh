          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="address-block">
                ...
                <ul>
                  <li>
                    <a href="https://www.instagram.com/esteh.creative/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                  </li>
                  <li>
                    <a href="https://wa.me/6281359883131"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                  </li>
                </ul>
              </div>
              <!-- /.address-block -->
