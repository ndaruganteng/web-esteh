          ...
          <div class="masnory-blog-wrapper">
            ...
            <div class="isotop-item economy marketing">
              <div class="blog-post-block-two mb-75 md-mb-50">
                <div class="img-holder"><img src="{{asset('storage/image/blog/'.$item->image)}}" alt=""  /></div>
                <div class="post">
                  <ul class="post-info">
                  ...
                  <p>{{ $item->except }}</p>
                  <a href="blogdetail/{{$item->slug}}" class="read-more inline-button-one">Continue Reading</a>
                </div>
                <!-- /.post -->
              </div>
              <!-- /.blog-post-block-two -->
