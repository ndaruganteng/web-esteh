...
<html lang="en">
  <head>
    ...
    <title>Esteh Creative - Login</title>
            <link
            rel="icon"
            type="image/png"
            sizes="56x56"
    ...
    <div class="h-screen flex mx-40">
      ...
      <div class="flex w-1/2 justify-center items-center bg-white  ">
        <form class="bg-white">
          ...
          <span class="mt-12 flex text-gray-400">Dont have an account ? <a href="{{ route('register.index') }}" class="hover:text-hijau">Sign up</a></span>
